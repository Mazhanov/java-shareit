...
public class ItemRequestClient extends BaseClient {
    ...
    public ResponseEntity<Object> getAllOwn(long requestorId) {
        return get("", requestorId);
    }

    public ResponseEntity<Object> getAllRequestOtherUsers(long requestorId, int from, int size) {
    ...
    public ResponseEntity<Object> getById(long requestorId, long requestId) {
