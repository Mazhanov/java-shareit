...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> createBooking(CreateBookingDto bookingCreateDto, long userId) {
        return post("", userId, bookingCreateDto);
    }

    public ResponseEntity<Object> changeStatusBooking(long userId, long bookingId, boolean status) {
        Map<String, Object> parameters = Map.of("approved", status);
